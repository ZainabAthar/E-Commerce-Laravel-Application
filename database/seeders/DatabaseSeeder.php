...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $product1 = Product::create([
            ...
            'images' => 'images\products\main_image\product-7-2.jpg',
            'created_at' => now(),
            'updated_at' => now(),
        ]);
        ...
        $product1->categories()->attach($shoes->id); // Attach 'Shoes' category to the product
            ...
            $product2 = Product::create([
                ...
                'stock_status' => 'instock',
                'quantity' => '34',
                'image' => 'images\products\main_image\product-9-1.jpg',
                'images' => 'images\products\main_image\product-9-2.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ]);
        ...
        $product2 = Product::create([
            ...
            'stock_status' => 'instock',
            'quantity' => '20',
            'image' => 'images\products\main_image\jsHDPFVbmkMLLboMLqdsEKVfmznr0GP8CIfjZj5C.jpg',
            'images' => 'images\products\main_image\mslFoKEyykTZWCw0nORfl8bOiNoZXjlkHPF8nY4a.jpg',
            'created_at' => now(),
            'updated_at' => now(),
        ]);
